...
class TestProductModel(unittest.TestCase):
    ...
    def test_deserialize_with_key_error(self):
        """It should raise DataValidationError on missing key"""
    ...
    def test_deserialize_with_type_error(self):
        """It should raise DataValidationError on invalid available type"""
        data = {
            "name": "Test",
            "description": "Test",
            "price": "10.00",
    ...
    def test_deserialize_with_attribute_error(self):
        """It should raise DataValidationError on invalid category"""
        data = {
            "name": "Test",
            "description": "Test",
            "price": "10.00",
    ...
    def test_update_product_with_no_id(self):
        ...
        product = Product(name="Test", description="Test", price=10.00)
